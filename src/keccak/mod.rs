...
use rayon::prelude::*;
use std::{cell::RefCell, collections::HashMap, env::set_var, iter, mem, borrow::BorrowMut};
...
impl<F: Field> KeccakChip<F> {
    ...
    pub fn verify_merkle_proof(
        ...
        ctx: &mut Context<F>,
        gate: &impl GateInstructions<F>,
        target_root :&impl AsRef<[AssignedValue<F>]> ,
