...
pub fn get_erc20_transfer_abi() -> Function {
    Function {
        ...
        inputs: vec![
            Param { name: "to".to_owned(), kind: ParamType::Address, internal_type: Some("address".to_owned()) },
            Param { name: "amount".to_owned(), kind: ParamType::Uint(256), internal_type: Some("uint256".to_owned()) },
        ],
        outputs: vec![
            Param { name: "".to_owned(), kind: ParamType::Bool, internal_type: Some("bool".to_owned()) }
        ],
        constant: None,
...
pub fn get_erc20_transfer_form_abi() -> Function {
    Function {
        ...
        inputs: vec![
            Param { name: "from".to_owned(), kind: ParamType::Address, internal_type: Some("address".parse().unwrap()) },
            Param { name: "to".to_owned(), kind: ParamType::Address, internal_type: Some("address".parse().unwrap()) },
            Param { name: "amount".to_owned(), kind: ParamType::Uint(256), internal_type: Some("uint256".parse().unwrap()) },
        ],
        outputs: vec![
            Param { name: "".to_owned(), kind: ParamType::Bool, internal_type: Some("bool".parse().unwrap()) }
        ],
        constant: None,
        state_mutability: StateMutability::NonPayable,
    }
