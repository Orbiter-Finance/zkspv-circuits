...
use crate::{keccak::SharedKeccakChip, Network, util::{EthConfigPinning, Halo2ConfigPinning}};
...
mod aggregation {
    ...
    use crate::block_header::ethereum::helpers::{BlockHeaderScheduler, CircuitType, Finality, Task};
