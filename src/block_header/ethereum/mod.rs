...
use crate::{ETH_LOOKUP_BITS, EthChip, EthCircuitBuilder, EthereumNetwork, keccak::{FixedLenRLCs, FnSynthesize, KeccakChip, VarLenRLCs}, Network,Field, rlp::{
...
use crate::util::helpers::{get_block_header_rlp_max_bytes, get_mainnet_block_header_rlp_max_field_lens};
...
impl<'chip, F: Field> EthBlockHeaderChip<F> for EthChip<'chip, F> {
    fn decompose_block_header_phase0(
        ...
        let max_field_lens = get_mainnet_block_header_rlp_max_field_lens(&network);
