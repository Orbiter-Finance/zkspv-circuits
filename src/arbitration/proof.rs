...
use crate::arbitration::types::{EthereumSourceProof, ProofsRouter, RouterType};
...
impl ProofRouter {
    pub fn new(proof: ProofsRouter, round: usize) -> Self {
        match &proof.router_type {
            RouterType::GoerliSource => {
                ...
                let transaction_task = TransactionTask {
                    input: get_eth_transaction_circuit(ethereum_transaction_constructor.clone()),
            ...
            RouterType::GoerliDest => {
                ...
                ProofRouter { arbitration_scheduler: scheduler, task }
            } // RouterType::MainnetSource => {}
              // RouterType::MainnetDest => {}
        }
    }
