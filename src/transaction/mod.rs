...
pub const EIP_2718_TX_TYPE_FIELDS_MAX_FIELDS_LEN:[usize;EIP_2718_TX_TYPE_FIELDS_NUM] = [32, 32, 32, 20, 32, TX_DATA_MAX_LEN, 32, 32, 32];
pub const EIP_1559_TX_TYPE_FIELDS_MAX_FIELDS_LEN:[usize;EIP_1559_TX_TYPE_FIELDS_NUM] = [32, 32, 32, 32, 32, 20, 32, TX_DATA_MAX_LEN, TX_ACCESS_LIST_MAX_LEN, 1, 32, 32];
