...
use crate::block_header::arbitrum::{EthBlockHeaderChip, EthBlockHeaderTrace, EthBlockHeaderTraceWitness};
...
use crate::util::helpers::{bytes_to_vec_u8, get_block_header_rlp_max_bytes, get_transaction_type};
...
impl EthBlockReceiptCircuit {
    pub fn from_provider(
        ...
        use crate::providers::get_arbitrum_receipt;

        let inputs = get_arbitrum_receipt(
            provider,
            block_number,
            receipt_index,
            receipt_rlp,
